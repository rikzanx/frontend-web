	...
	<div class="container">
		<div class="row ft-sec-1">
			...
			<div class="col" id="ftSec3">
				<ul class="footer">
					<li class="ft-item">
						<a href="{{ route('ternakmart.index') }}" class="ft-link">Ternakmart</a>
					</li>
					<li class="ft-item">
						<a href="{{ route('ternakinvest.index') }}" class="ft-link">TernakInvest</a>
					</li>
					{{-- <li class="ft-item">
						<a href="#" class="ft-link">Aqiqah</a>
					</li> --}}
					<li class="ft-item">
						<a href="#" class="ft-link">Smartqurban</a>
					</li>
				</ul>
			</div>
