...
<link href="{{ asset('css/pahlawan-pangan.css') }}" rel="stylesheet">
@endsection
        ...
        <div class="carousel-berbagi">
          <div class="carousel-item">
            <div class="card berbagi-card">
              <div class="background-block">
  							<img class="background" src="{{asset('img/assets/pahlawan-pangan/anak-ditinggal-ibunya.png')}}">
  						</div>
              <div class="card-content">
                <span class="content-title">Berbagi Susu</span>
  							<span class="content-body">Bagikan kebahagiaan dengan berbagi...</span>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="card berbagi-card">
              ...
              <div class="card-content">
                <span class="content-title">Berbagi Sembako</span>
  							<span class="content-body">Bagikan kebahagiaan dengan berbagi...</span>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="card berbagi-card">
              ...
              <div class="card-content">
                <span class="content-title">Berbagi Donasi</span>
  							<span class="content-body">Bagikan kebahagiaan dengan berbagi...</span>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="card berbagi-card">
              ...
              <div class="card-content">
                <span class="content-title">Berbagi Ternak</span>
  							<span class="content-body">Bagikan kebahagiaan dengan berbagi...</span>
              </div>
            </div>
          </div>
