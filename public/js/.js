...
function showPosition(position) {
    ...
    location.href = "ternakmart-market?lat=" + position.coords.latitude + "&lng=" + position.coords.longitude;
}
function change_category(id) {
    let searchParams = new URLSearchParams(window.location.search);
    var loc = searchParams.has('lat');
    if (loc == true) {
        location.href = "ternakmart-market?lat=" + searchParams.get('lat') + "&lng=" + searchParams.get('lng') + "&category=" + id;
    } else {
        location.href = "ternakmart-market?category=" + id;
    }
}
function change_page(page) {
    ...
    location.href = "ternakmart-market?lat=" + searchParams.get('lat') + "&lng=" + searchParams.get('lng') + "&category=" + category + "&page=" + page;
}
